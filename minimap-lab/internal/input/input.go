...
// SelectEmitter turns the -input flag into an emitter. "off" returns no
// emitter at all, leaving the panel in the read-only behaviour it had before
// control existed; the caller answers every input route with 503.
